...
const tabsListVariants = cva(
  // A horizontal tab bar that can't fit scrolls sideways rather than dragging
  // its container wider — six tabs in a drawer on a phone was pushing the whole
  // panel off-screen. The scrollbar itself is hidden: the cut-off tab is the
  // affordance, and a bar under the tabs would read as chrome.
  //
