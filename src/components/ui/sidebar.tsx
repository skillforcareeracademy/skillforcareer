...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // `min-w-0` is essential: without it this flex item grows to its
        // widest child (e.g. a wide table), overflowing the viewport instead of
        // letting inner `overflow-x-auto` regions scroll.
